  ...
  <main className="bg-background min-h-screen">
    <div className="container mx-auto px-4 sm:px-6 py-16 max-w-3xl">
      ...
      <div className="prose max-w-none space-y-6 text-foreground/70">
        ...
        <section>
          <h2 className="text-xl font-display font-semibold text-foreground mb-3">1. Aceitação dos Termos</h2>
        ...
        <section>
          <h2 className="text-xl font-display font-semibold text-foreground mb-3">2. Descrição do Serviço</h2>
        ...
        <section>
          <h2 className="text-xl font-display font-semibold text-foreground mb-3">3. Conteúdo Informativo</h2>
        ...
        <section>
          <h2 className="text-xl font-display font-semibold text-foreground mb-3">4. Propriedade Intelectual</h2>
        ...
        <section>
          <h2 className="text-xl font-display font-semibold text-foreground mb-3">5. Limitação de Responsabilidade</h2>
        ...
        <section>
          <h2 className="text-xl font-display font-semibold text-foreground mb-3">6. Links Externos</h2>
        ...
        <section>
          <h2 className="text-xl font-display font-semibold text-foreground mb-3">7. Alterações nos Termos</h2>
        ...
        <section>
          <h2 className="text-xl font-display font-semibold text-foreground mb-3">8. Legislação Aplicável</h2>
        ...
        <section>
          <h2 className="text-xl font-display font-semibold text-foreground mb-3">9. Contato</h2>
